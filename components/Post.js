...
export default function Post({post}) {
  return (
    <div className='flex p-3 cursor-pointer border-b border-gray-200'>
        {/* User Image */}
        <img className='h-11 w-11 rounded-full mr-4' src='/img/avatar-man.png' alt='user-img'/>
        {/* right side */}
        <div className=''>
            {/* Header */}
            ...
            {/* post image */}
            <img src='/img/bg1.jpg' alt='post-img' className='rounded-2xl mr-2'/>
            {/* icons */}
            <div className='flex justify-between text-gray-500 p-2 '>
                ...
                <HeartIcon className='h-9 hoverEffect p-2 hover:text-rose-500 hover:bg-rose-100'/>
